...
выполнил все команды из примеров (рис. [-@fig:001]).

![команды примера](image/1.png){#fig:001 width=70%}

скопировал, переместил, создал директорию в домашнем каталоге, переместил в него необходимые файлы, создал и переместил newdir, назвал его plans. (рис. [-@fig:002]).

![команды для выполнения пункта 2](image/2.png){#fig:001 width=70%}

написал команды для присвоения нужных прав доступа (рис. [-@fig:003]).

![команды для изменения прав доступа](image/3.png){#fig:001 width=70%}

проделал команды из 4го пункта и сфоткал их для отчета. При просмотре файла feather - ошибка нет прав, при его копировании - ошибка нет прав (рис. [-@fig:004]).

![команды по порядку](image/4.png){#fig:001 width=70%}
...
- Команда Kill посылает указанный сигнал указанному процессу. Если не указано ни одного сигнала, посылается сигнал SIGTERM. Сигнал SIGTERM завершает лишь те процессы, которые не обрабатывают его приход. Для других процессов может быть необходимым послать сигнал SIGKILL, поскольку этот сигнал перехватить невозможно рис. [-@fig:005]).

![просмотр инфо по командам](image/5.png){#fig:001 width=70%}
